  ...
  <header class=" border-b dark:border-gray-800  sticky bg-yellow-50 z-50 dark:bg-gray-900 dark:text-white  text-gray-600 body-font">
    <div class="container mx-auto flex p-4 flex-col md:flex-row items-center">
      <router-link to="/" class="flex title-font font-medium items-center text-gray-900 dark:text-white mb-4 md:mb-0">
        ...
        <span class="ml-3 text-xl">Oussama</span>
      </router-link>
      <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base  justify-center">
        <router-link to="/" class="px-5 py-2 rounded hover:text-gray-900 dark:hover:bg-gray-400"
          :class="{ 'bg-gray-600 text-white rounded': $route.path === '/' }">
          Home </router-link>
        <router-link to="/projects" class="px-5 py-2  rounded hover:text-gray-900 dark:hover:bg-gray-400"
        :class="{ 'bg-gray-600 text-white rounded': $route.path === '/projects' }">My projects</router-link>
      <router-link to="/contact" class="px-5 py-2 rounded hover:text-gray-900 dark:hover:bg-gray-400"
        :class="{ 'bg-gray-600 text-white rounded': $route.path === '/contact' }">Contact Me</router-link>
      <router-link to="/Downloads" class="rounded px-5 py-2 hover:text-gray-900 dark:hover:bg-gray-400"
        :class="{ 'bg-gray-600 text-white rounded': $route.path === '/Downloads' }">Downloads</router-link>
    </nav>
