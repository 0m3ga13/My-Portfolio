...
export default {
  ...
  data() {
    return {
      ...
      projects: [
        { name: 'Bicycle Eshop', Description: 'a responsive website using React and Threejs', image: 'https://github.com/0m3ga13/0m3ga13.github.io/blob/main/src/assets/img/bicyx.webp?raw=true', demosrc: 'https://bicyx.netlify.app/', codesrc: 'https://github.com/0m3ga13/Bicy-x' },
        { name: 'Ecommerce Website', Description: 'a responsive website, using Vue and Tailwind.', image: 'https://github.com/0m3ga13/0m3ga13.github.io/blob/main/src/assets/img/electronics.webp?raw=true', demosrc: 'https://masterpurple.netlify.app/', codesrc: 'https://github.com/0m3ga13/Ecommerce-Website' },
        { name: 'Business Website', Description: 'a MEVN stack website with a REST API', image: 'https://github.com/0m3ga13/0m3ga13.github.io/blob/main/src/assets/img/cominox.webp?raw=true', demosrc: 'https://cominox.netlify.app/', codesrc: 'https://github.com/0m3ga13/cominox' },
        ...
        { name: 'this portfolio', Description: 'Dynamic portfolio using Vue and Tailwind', image: 'https://github.com/0m3ga13/0m3ga13.github.io/blob/main/src/assets/img/portfolio.webp?raw=true', demosrc: 'https://github.com/0m3ga13/present_students_names', codesrc: 'https://github.com/0m3ga13/present_students_names' },
        { name: 'Business Landing Page', Description: 'a simple landing page for a business', image: 'https://github.com/0m3ga13/0m3ga13.github.io/blob/main/src/assets/img/obsidex.webp?raw=true', demosrc: 'https://github.com/0m3ga13/Obsidex-Landing-Page', codesrc: 'https://github.com/0m3ga13/Obsidex-Landing-Page' },
        { name: 'Influencer Contact Page', Description: 'Basic Arabic page for contacts', image: 'https://github.com/0m3ga13/0m3ga13.github.io/blob/main/src/assets/img/sid.webp?raw=true', demosrc: 'https://oussama-sid.netlify.app/', codesrc: 'https://github.com/0m3ga13/Oussama-sid' },
