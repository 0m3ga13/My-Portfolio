  ...
  data() {
    return {
      ...
      projects: [
        ...
        { name: 'face recognition app', Description: 'Python/OpenCV script detecting faces in a video and store their names', image: 'https://source.unsplash.com/OfwiURcZwYw/1600x900', demosrc: 'https://github.com/0m3ga13/present_students_names', codesrc: 'https://github.com/0m3ga13/present_students_names' },
