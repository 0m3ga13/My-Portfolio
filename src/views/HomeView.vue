<template>
  <div class="h-screen flex flex-col md:justify-center items-center bg-yellow-50 dark:bg-gray-900 dark:text-white overflow-hidden">
    ...
    <router-link to="/projects" class="max-sm:hidden sm:fixed bottom-5 transition-colors duration-300">
...
.hi {
  opacity: 0;
  animation: drop 0.2s linear forwards;
  color: black;
}
